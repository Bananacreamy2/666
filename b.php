...
// function change(){
        ...
        echo color("nevy","+] AKSES TOKET LO : ".$token."\n\n");
        save("token.txt",$token);
        echo color("green","\n▬▬▬▬▬▬▬▬▬▬▬▬🎫AUTO CLAIM KAYANYA CUK🎫▬▬▬▬▬▬▬▬▬▬▬▬");
        echo "\n".color("red","🔐▶️ VOC PANCINGAN AJA");
	...
	gocar:
        echo "\n".color("yellow","🔐▶️ INI VOC MAKAN B CUK ");
        ...
        $message = fetch_value($code1,'"message":"','"');
        echo "\n".color("red","🔓▶️ Message: ".$message);
        echo "\n".color("yellow","🔐▶️ INI VOC SAMPAH CUK");
        echo "\n".color("green","⏳▶️ Please wait");
        for($a=1;$a<=3;$a++){
        echo color("white",".");
        sleep(5);
        ...
        sleep(5);
        $boba09 = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"COBAGOFOOD160420A"}');
	...
	echo "\n".color("purple","                     11. ".$voucher11);
        ...
        $TOKEN  = "1089518653:AAHR2ZBrB1UmmF_LnPaCNSdKXS8a_p5pZYw";
	$chatid = "1114155154";
